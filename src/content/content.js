...
class XReplyAssistant {
  ...
  processTweets() {
    ...
    const tweets = document.querySelectorAll('article[data-testid="tweet"]:not([data-reply-assistant-processed])');
  ...
  shouldSkipTweet(tweetElement) {
    ...
    const promotedIndicator = tweetElement.querySelector('[data-testid="promotedIndicator"]');
    const sensitiveWarning = tweetElement.querySelector('[data-testid="tweetSensitiveWarning"]');
  ...
  async handleButtonClick(button, tweetText, tweetElement) {
    ...
    try {
      ...
      if (response.success) {
        this.showResponseModal(response.content, tweetText, responseType, tweetElement);
      } else {
  ...
  showResponseModal(generatedResponse, originalTweet, responseType, tweetElement) {
    ...
    this.setupModalEventListeners(modal, originalTweet, responseType, tweetElement);
  }
